...
public class BackgroundTaskControllerTest extends MindmapsEngineTestBase {
    ...
    public void testGetAllTasks() throws Exception {
        get("/backgroundtasks/all")
                ...
                .and().body(singleTask, equalTo(TaskStatus.COMPLETED.toString()));
    }

    @Test
    public void testTasksByStatus() throws Exception {
        get("/backgroundtasks/tasks/"+TaskStatus.COMPLETED.toString())
                .then().statusCode(200)
                .and().contentType(ContentType.JSON)
    ...
    public void testGetTask() {
        get("/backgroundtasks/task/"+singleTask)
                .then().statusCode(200)
                .and().body("status", equalTo(TaskStatus.COMPLETED.toString()));
    }
    ...
    public void testPauseResume() {
        ...
        get("/backgroundtasks/task/"+uuid)
                .then().statusCode(200)
                .and().contentType(ContentType.JSON)
                .and().body("status", equalTo(TaskStatus.PAUSED.toString()));
        ...
        get("/backgroundtasks/task/"+uuid)
                .then().statusCode(200)
                .and().contentType(ContentType.JSON)
                .and().body("status", anyOf(equalTo(TaskStatus.RUNNING.toString()),
                                                  equalTo(TaskStatus.COMPLETED.toString())));
    }
    ...
    public void testStopRestart() {
        ...
        get("/backgroundtasks/task/"+uuid)
                .then().statusCode(200)
                .and().contentType(ContentType.JSON)
                .and().body("status", equalTo(TaskStatus.STOPPED.toString()));
        ...
        get("/backgroundtasks/task/"+uuid)
                .then().statusCode(200)
                .and().contentType(ContentType.JSON)
                .and().body("status", anyOf(equalTo(TaskStatus.SCHEDULED.toString()),
                                                  equalTo(TaskStatus.RUNNING.toString()),
                                                  equalTo(TaskStatus.COMPLETED.toString())));
    }
}
