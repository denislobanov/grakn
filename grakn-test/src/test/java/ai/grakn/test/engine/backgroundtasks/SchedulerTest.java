...
public class SchedulerTest extends AbstractEngineTest {
    ...
    public void testRecurringTasksStarted() throws Exception{
        ...
        TaskState state = task.getValue();

        // force scheduler restart
        ClusterManager.getInstance().getScheduler().close();
    ...
    public void waitUntilScheduled(Collection<String> tasks){
        tasks.forEach(this::waitUntilScheduled);
    }

    public void waitUntilScheduled(String taskId){
