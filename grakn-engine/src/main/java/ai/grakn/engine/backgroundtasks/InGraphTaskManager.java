...
public class InGraphTaskManager extends AbstractTaskManager {
     ...
     */
    protected String saveNewState(TaskState state) throws GraknValidationException {
    ...
    protected String updateTaskState(String id, TaskState state) throws GraknValidationException {
    ...
    protected ScheduledFuture<BackgroundTask> getTaskExecutionStatus(String id) { return taskFutures.get(id); }
    ...
    private String getVarID(Var var) throws GraknValidationException {
