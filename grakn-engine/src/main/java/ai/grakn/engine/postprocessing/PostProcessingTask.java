...
import static ai.grakn.engine.util.ConfigProperties.POSTPROCESSING_DELAY;
...
public class PostProcessingTask implements BackgroundTask {
    ...
    private static final long timeLapse = properties.getPropertyAsLong(POSTPROCESSING_DELAY);
